    ...
    return (
        ...
        <ul className="articles__table">
                ...
                <li className="articles__card">
                    ...
                    <h3 className="articles__title">Декоративная штукатурка</h3>
                ...
                <li className="articles__card">
                    ...
                    <h3 className="articles__title">Минимализм и простота кухни</h3>
                    <p className="articles__text">Кухня всегда остается одной из самых часто посещаемых комнат вашего дома и эдаким «коммуникативным центром» всей семьи. Мы готовы поделиться основными простыми советами как привнести…</p>
                    <div className="articles__box">
                        <div className="articles__line"></div>
                        <a className="articles__link" href="#">подробнее</a>
                    </div>
